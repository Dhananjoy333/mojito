...
function Menu() {
  ...
  return (
    <section id='menu' aria-labelledby='menu-heading'>
        <Image src="/images/slider-left-leaf.png" alt='left-leaf' width={400} height={400} id='m-left-leaf'/>
        <Image src="/images/slider-right-leaf.png" alt='right-leaf' width={400} height={400} id='m-right-leaf'/>
        ...
        <div className='content'>
            <div className='arrows'>
                ...
                <Image src="/images/right-arrow.png" alt='right-arrow' width={40} height={40} aria-hidden="true"/>
                </button>
                <button className='text-left' onClick={()=> goToSlide(currentIndex + 1)}>
                <span>{nextCocktail.name}</span>
                <Image src="/images/left-arrow.png" alt='left-arrow' width={40} height={40} aria-hidden="true"/>
                </button>
            </div>
            <div className='cocktail'>
                <Image src={currentCocktail.image} className='object-contain' alt='current-cocktail' width={4000} height={4000}/>
            </div>
